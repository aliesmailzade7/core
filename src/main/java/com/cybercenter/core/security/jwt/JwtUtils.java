...
import com.cybercenter.core.dto.JwtResponseDTO;
import com.cybercenter.core.service.RefreshTokenService;
...
public class JwtUtils {
    ...
    public JwtResponseDTO generateJwtToken(Authentication authentication) {
        ...
        claims.put("userId", userPrincipal.user().getId());
    ...
    public JwtUserDetails getJwtTokenInfo(HttpServletRequest request) {
        ...
        if (!ObjectUtils.isEmpty(token)) {
            ...
            jwtUserDetails.setId(String.valueOf(claims.get("userId")));
